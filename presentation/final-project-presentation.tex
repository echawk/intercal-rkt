...
\begin{frame}
  ...
  \begin{block}{Current Status}
    The implementation now runs multiple upstream-style programs including \texttt{fib.i}, \texttt{hanoi.i}, \texttt{hello.i}, \texttt{life.i}, \texttt{beer.i}, \texttt{rot13.i}, and \texttt{unlambda.i} for its hello-world input.
  \end{block}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \input{generated/sample-source.tex}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.50\textwidth}
      \input{generated/reader-snippet.tex}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \input{generated/lexer-snippet.tex}
    \end{column}
    \begin{column}{0.47\textwidth}
      \begin{itemize}
...
\begin{frame}[fragile]
  ...
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      ...
      \input{generated/sample-parse.tex}
    \end{column}
    \begin{column}{0.48\textwidth}
      \textbf{Normalized IR}
      \input{generated/sample-normalized.tex}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \input{generated/sample-module.tex}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{columns}[T]
    \begin{column}{0.57\textwidth}
      \input{generated/macro-snippet.tex}
    \end{column}
  ...
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      ...
      \begin{itemize}
        \item \texttt{fib.i}
        \item \texttt{hanoi.i}
        \item \texttt{onceagain.i}
        \item \texttt{hello.i}
        \item \texttt{ignorret.i}
        \item \texttt{beer.i}
        \item \texttt{life.i}
        \item \texttt{rot13.i}
        \item \texttt{unlambda.i} (hello-world input)
      \end{itemize}
    \end{column}
